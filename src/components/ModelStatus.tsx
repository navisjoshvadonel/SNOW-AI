...
const MODELS_REGISTRY: HybridModel[] = [
  {
    id: "gemini-2.5-flash",
    name: "Gemini 2.5 Flash (Active Core)",
    type: "Cloud Neural Multimodal Core",
    status: "ONLINE",
    latency: 75,
    parameters: "High-Speed Realtime Audio & Vision",
    useCase: "Astra real-time vision, speech & execution",
  },
  {
    id: "gemini-2.5-flash-lite",
    name: "Gemini 2.5 Flash-Lite",
    type: "Next-Gen Flash Lite Core",
    status: "ONLINE",
    latency: 45,
    parameters: "Low-Latency Core",
    useCase: "Hyper-fast conversational intelligence",
  },
  {
    id: "deepseek",
    name: "DeepSeek Reasoning Node",
    type: "Deep Logic Tier",
    status: "ONLINE",
    latency: 185,
    parameters: "High Capacity Core",
    useCase: "Complex reasoning & deep logic",
  },
  {
    id: "gemini-1.5-flash",
    name: "Gemini 1.5 Flash",
    type: "Cloud Lightweight",
    status: "ONLINE",
    latency: 110,
    parameters: "Standard Multimodal",
    useCase: "Efficient knowledge processing",
  },
  {
    id: "ollama",
    ...
    status: "ONLINE",
    latency: 12,
    parameters: "Offline Private Node",
    useCase: "Private offline processing",
  }
];
